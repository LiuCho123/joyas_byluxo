...
public class ExcelExportService {
    ...
    public ByteArrayInputStream exportarExcelCompleto() throws IOException {
        try (Workbook workbook = new XSSFWorkbook(); ByteArrayOutputStream out = new ByteArrayOutputStream()) {
            ...
            // --- SE AGREGARON LAS COLUMNAS NUEVAS ---
            String[] colJoyas = {
                    "Nombre", "Categoría", "Fecha Adquisición", "Largo", "Peso",
                    "Precio", "Oferta", "Límite Oferta", "Stock",
            ...
            for (Joya joya : joyas) {
                ...
                row.createCell(1).setCellValue(joya.getCategoria() != null ? joya.getCategoria() : "");
                row.createCell(2).setCellValue(joya.getFechaAdquisicion() != null ? joya.getFechaAdquisicion().toString() : "");
                row.createCell(3).setCellValue(joya.getLargo() != null ? joya.getLargo() + "cm" : "");
                row.createCell(4).setCellValue(joya.getPeso() != null ? joya.getPeso() + "g" : "");
                row.createCell(5).setCellValue(joya.getPrecio() != null ? joya.getPrecio() : 0);
                row.createCell(6).setCellValue(joya.getPrecioOferta() != null ? joya.getPrecioOferta() : 0);
                row.createCell(7).setCellValue(joya.getFechaLimiteOferta() != null ? joya.getFechaLimiteOferta().toString() : "");
                row.createCell(8).setCellValue(joya.getStock() != null ? joya.getStock().toString() : "");

                EstadoRedes redes = joya.getEstadoRedes();
                if (redes != null) {
                    row.createCell(9).setCellValue(redes.getIgEstado() != null ? redes.getIgEstado() : "");
                    row.createCell(10).setCellValue(redes.getIgUltimaFecha() != null ? redes.getIgUltimaFecha() : "");
                    row.createCell(11).setCellValue(redes.getIgFormato() != null ? redes.getIgFormato() : "");
                    row.createCell(12).setCellValue(redes.getTkEstado() != null ? redes.getTkEstado() : "");
                    row.createCell(13).setCellValue(redes.getTkUltimaFecha() != null ? redes.getTkUltimaFecha() : "");
                    row.createCell(14).setCellValue(redes.getTkFormato() != null ? redes.getTkFormato() : "");
                    row.createCell(15).setCellValue(redes.getMkpEstado() != null ? redes.getMkpEstado() : "");
                    row.createCell(16).setCellValue(redes.getMkpUltimaFecha() != null ? redes.getMkpUltimaFecha() : "");
                    row.createCell(17).setCellValue(redes.getMkpConversacion() != null ? redes.getMkpConversacion() : "");
                    row.createCell(18).setCellValue(redes.getWspCatalogo() != null ? redes.getWspCatalogo() : "");
                    row.createCell(19).setCellValue(redes.getWspUltimaFecha() != null ? redes.getWspUltimaFecha() : "");
                }
            }
            for (int i = 0; i < colJoyas.length; i++) sheetJoyas.autoSizeColumn(i);

            // HOJAS DE FLUJOS (Intactas)
            ...
            Map<String, List<Transaccion>> transPorMes = todasTransacciones.stream()
                    ...
                    .collect(Collectors.groupingBy(t -> {
                        ...
                        return "Flujo " + mes.substring(0, 1) + mes.substring(1).toLowerCase();
                    }));
